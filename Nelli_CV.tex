...
\section{Experience}
  ...
  \resumeItem{Develop alternative patch workflow for designers to decrease
  iteration time. Included Qt6 GUI, hook into pipeline code, wrote
  engine code, and communicated with level designers on desired features.}
  \resumeItem{Forward settings through pipeline to engine. Change how enginer
  determines which data to load into game. Used python pipeline, pipeline, engine code.}
    \resumeItemListEnd
