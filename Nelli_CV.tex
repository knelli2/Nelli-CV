...
\usepackage[maxbibnames=99,sorting=ndymdt]{biblatex}
...
\section{Experience}
  ...
  (150+ people).}
\resumeItem{Updated control loops in the Spectral Einstein Code (SpEC)
which runs highly accurate simulations of binary black hole
mergers. SpEC utilizes MPI for it's parallelization and has been run on large clusters
like Frontera at TACC.} 
      \resumeItemListEnd
\resumeSubsubheading{Lead \href{https://spectre-code.org/}{SpECTRE} Developer/Engineer}{} 
    \resumeItemListStart
  \resumeItem{\href{https://github.com/sxs-collaboration/spectre}{Open-sourced}
...
relativistic magneto-hydro dynamics on HPC and exascale machines.}
  \resumeItem{Visualized $\sim$1TB of output from simulations using Paraview and its
  ...
  \resumeItem{Expert on utilizing task-based (asynchonous) parallelism to solve
  partial differential equations on exascale computing resources.}
  \resumeItem{Expert in modern C++.}
  \resumeItem{Designed and oversaw several complex student projects. Mentored
  undergraduate, masters, and other doctoral students in these projects.}
    \resumeItemListEnd
  ...
  \resumeItem{Wrote novel code in Python and C++ to automate visualization using
...
\section{Skills Summary}
	\resumeSubHeadingListStart
	\resumeSubItem{Languages}{~~~C/C++, Python, Bash, Perl, Mathematica}
	\resumeSubItem{Software}{~~~~~~SpECTRE, SpEC, VSCode, \LaTeX,
...
\resumeSubHeadingListStart
    \resumeAward{APS DGRAV Travel Grant}{April 2023}{\$300}
