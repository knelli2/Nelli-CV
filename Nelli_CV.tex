...
internship with Rivian. I am eager to apply my experience writing
highly-parallel physics-based simulations using C++, Python, and GPUs to
developing similar types of simulations at Rivian. I have in-depth experience
with high-performance computing (HPC), multi-physics systems, control systems,
and a host of numerical methods including both spectral and finite-element (FE)
methods which I believe will be an asset to the team at Rivian.
