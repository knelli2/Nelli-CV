...
systems engineering internship with Blizzard. I am eager to apply my experience
writing highly-parallel physics-based simulations using C++, Python, and GPUs to
develop and enhance low level CPU systems that interface with games. I have a
