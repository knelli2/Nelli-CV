...
physics-based simulations using C++, Python, and GPUs to developing game engine
tools for the Unreal Editor and Unreal Engine across operating systems. I have a
keen eye for debugging and profiling complex simulations along with very strong
physics, mathematics, and computer science skills which I believe will be an
asset to the team at Epic.
