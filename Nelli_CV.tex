...
\section{Objective}
Extremely dedicated software engineer and physics PhD student seeking an internship at
Autodesk for Summer 2025. I am eager to build upon my current experience using
C++ and Python along with continuous integration to learn about the Agile and
Scrum working practices used to develop Fusion 360 at Autodesk.
