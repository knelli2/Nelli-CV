...
internship with Meta. I am eager to apply my experience solving PDEs for
highly-parallel physics-based simulations using C++, Python, and GPUs to
interactive simulations of soft deformable bodies and fluids for MR and VR. I
have a keen eye for developing user-oriented software along with very strong
physics, mathematics, and computer science skills which I believe will be an
asset to the team at Meta.
