...
\section{Experience}
  ...
  \resumeItem{Restored determinism to modules for building maps.}
    \resumeItemListEnd
  \resumeSubheading{Lead Software Engineer}{May 2023 - Present}{Caltech}{}
    \resumeItemListStart
  \resumeItem{Open-source software \href{https://github.com/sxs-collaboration/spectre}{SpECTRE} (750k+
  lines of C++ 20) designed to run highly accurate simulations
  of black hole collisions on CPUs and GPUs.}
  \resumeItem{Merged \textbf{480 Pull Requests, added 1,300 commits, and changed 160,000 lines}.}
  ...
  \resumeItem{Instructed undergraduate students on ``best coding practices''.}
