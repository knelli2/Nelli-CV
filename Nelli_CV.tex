...
internship at Blender. I am eager to apply my experience with
highly-parallel physics-based simulations using C++, Python, and GPUs by working
on the physics engine in Blender. I particularly would love to expand upon my
current skill set and learn more about 3D rendering, physics modules in
animation software, and computer graphics at Blender.
