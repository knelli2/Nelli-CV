...
Production Engineering internship with ILM. I am eager to apply my experience
writing 3D fluid simulations using C++, Python, and GPUs to developing tools for
rendering and stylized simulations in animation software. I have been a project
lead for over a year with a keen eye for developing user-oriented software, have
experience designing and working in pipelines, and have excellent communication
skills. I believe my software and physics experience will be a valued asset to
the team at ILM.
