...
internship with Epic Games. I am eager to apply my experience writing
physics-based simulations using C++, Python, and GPUs to developing gameplay
systems with Fortnite's Player Expression team. I have a keen eye for debugging
and profiling complex systems, porting new features to a codebase, and very
strong communication skills from being in an international collaboration. All of
which I believe will be an asset to the team at Epic.
