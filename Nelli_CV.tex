...
\section{Experience}
  \resumeSubHeadingListStart
  \resumeSubheading{Research Associate, Enginnering}{Aug 2025 - Feb 2026}{Activision}{}
    \resumeItemListStart
  \resumeItem{Restored determinism to pre-processing executables for Call of Duty maps.}
    \resumeItemListEnd
