...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  \href{https://github.com/knelli2}{Github: ~~github.com/knelli2} & Mobile:~~~1-847-494-5028 \\
\end{tabular*}
...
\section{~~Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      {University of Illinois Urbana-Champaign}{August 2016 - May 2020}
      {Bachelor of Science; Engineering Physics}{Bachelor of Science; Astronomy}
